...
const Layout = ({ content, page }: any) => {
  return (
    <div className="flex">
      <div className="w-1/5 bg-[#17212e]">side menu</div>
      <div className="w-3/4 h-[100vh] overflow-y-scroll no-scrollbar">
        <div className="px-5 flex items-center fixed w-full h-[10vh] bg-[#131a25]">
